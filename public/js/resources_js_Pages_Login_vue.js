...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    login: function login() {
      ...
      _Apis_Auth__WEBPACK_IMPORTED_MODULE_0__.default.login(this.form).then(function (response) {
        localStorage.setItem("auth", response.data.user.role);
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              return _context.abrupt("return", _Api__WEBPACK_IMPORTED_MODULE_1__.default.post("/admin/register", form));
